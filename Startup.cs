...
namespace AcademicCoursesCRUD
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AcademicCoursesContext>(options =>
                  options.UseSqlServer("Server=Hady-Sharawi\\SQLEXPRESS;Database=AcCourses;Trusted_Connection=True;MultipleActiveResultSets=true"));
            services.AddTransient<IAcademicCourseRepository, AcademicCoursesRepository>();
